...
void MD5::update(ifstream& in) {
     ...
     calculateThread->setFileProgressBar(0);
//     calculateThread->needStop=false;//初始化
     //以下是主循环
     while (!in.eof()) {
         //假如点击了停止按钮停止计算
         if(calculateThread->stopRun())
             break;
          ...
          if(currentPercent>lastPercent)
          {
              ...
              calculateThread->setFileProgressBar(currentPercent);
          }
     }
     calculateThread->setFileProgressBar(100);
     in.close();
}
